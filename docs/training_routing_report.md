...
*(Dành riêng cho Phó Admin / Sub Admin)*
...
* **Kết quả tự động của hệ thống**:
  ...
  * Tự động tạo 1 Task công việc mới cho Sale đó với tiêu đề *"Liên hệ khách hàng [Tên khách] từ phân tuyến"*, hạn chót là ngày mai.
  * Gửi một Notification (Thông báo) trực tiếp đến tài khoản của Sale: *"Bạn đã được giao khách hàng mới..."*.
...
* **Lưu ý**: Sau khi lưu tọa độ thành công, khách hàng sẽ tự động biến mất khỏi nhóm *"Chưa ghim vị trí"* và tự động được hệ thống tính toán khoảng cách để xếp vào nhóm phân tuyến hợp lý.
...
---
*Chúc đội ngũ Phó Admin vận hành hệ thống hiệu quả, tối ưu hóa tối đa nguồn lực doanh nghiệp!*
