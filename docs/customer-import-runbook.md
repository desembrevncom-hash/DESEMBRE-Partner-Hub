...
_(Lưu ý: Hệ thống **KHÔNG** hỗ trợ import file vượt quá **2.000 dòng** trong 1 lần để đảm bảo an toàn bộ nhớ và hiệu suất kiểm duyệt của UI)._
...
4. **Review Batch (Đánh giá)**: Tại phần _Lịch sử Import_, tìm lô dữ liệu vừa tạo (trạng thái: `Staging`). Bấm **Review** để xem chi tiết các dòng hợp lệ, bị trùng, hoặc lỗi.
