...
const textCounts = countRegex(
  /\b(text-(xs|sm|base|lg|xl|2xl|3xl|4xl|\[10px\]|\[11px\]|\[13px\]))\b/g,
  "./src",
);
const weightCounts = countRegex(
  /\b(font-(light|normal|medium|semibold|bold|extrabold|black))\b/g,
  "./src",
);

console.log(
  "Rounded:",
  Object.entries(roundedCounts)
    .sort((a, b) => b[1] - a[1])
    .slice(0, 10),
);
console.log(
  "Shadow:",
  Object.entries(shadowCounts)
    .sort((a, b) => b[1] - a[1])
    .slice(0, 10),
);
console.log(
  "Padding:",
  Object.entries(paddingCounts)
    .sort((a, b) => b[1] - a[1])
    .slice(0, 10),
);
console.log(
