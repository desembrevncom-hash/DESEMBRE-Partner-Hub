-- ============================================================================
-- FIX: Customer Timeline Error
-- ============================================================================

-- 1. Thêm cột metadata cho customer_activities (nếu chưa có)
ALTER TABLE public.customer_activities ADD COLUMN IF NOT EXISTS metadata jsonb DEFAULT '{}'::jsonb;

-- 2. Cập nhật lại Hàm Timeline với Casting chuẩn xác
