...
-- 3. Áp dụng ràng buộc mới hỗ trợ trọn vẹn 3 quyền: admin, sub_admin, sale
ALTER TABLE public.user_roles ADD CONSTRAINT user_roles_role_check CHECK (role IN ('admin', 'sub_admin', 'sale'));
