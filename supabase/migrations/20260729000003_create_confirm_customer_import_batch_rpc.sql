-- Phase 4C: PostgreSQL RPC for Safe Batch Import Confirmation
-- ID: 20260729000003_create_confirm_customer_import_batch_rpc.sql
        ...
        BEGIN
            ...
            BEGIN
                INSERT INTO public.customer_activities (
                    ...
                    v_user_id,
                    jsonb_build_object('batch_id', p_batch_id, 'import_row_id', v_row.id)
                );
