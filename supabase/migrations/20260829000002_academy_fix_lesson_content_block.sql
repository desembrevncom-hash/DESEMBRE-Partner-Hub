-- Fix get_academy_lesson_content to explicitly check ACCESS_BLOCKED
...
BEGIN
  ...
  SELECT id, content_type, content_body, media_ref, storage_bucket, storage_path, mime_type, original_filename
  INTO v_content
