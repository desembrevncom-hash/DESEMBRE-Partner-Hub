...
describe('C. Route Optimization (Nearest Neighbor)', () => {
  ...
  it('1. Single customer optimization', () => {
    const customers = [
      { id: '1', latitude: 20.9817414, longitude: 105.7847142, name: 'Lan Anh' }
    ];
  ...
  it('2. Multi-point optimization checks', () => {
    const custA = { id: 'A', latitude: 20.990, longitude: 105.800 }; // Very close
    const custB = { id: 'B', latitude: 21.050, longitude: 105.850 }; // Far
    const custC = { id: 'C', latitude: 20.980, longitude: 105.790 }; // Very close
  ...
  it('3. Waypoints missing coordinates should be excluded', () => {
    const custA = { id: 'A', latitude: 20.990, longitude: 105.800 };
    const custB = { id: 'B', latitude: null, longitude: null }; // Lacks GPS
    const custC = { id: 'C', latitude: 20.980, longitude: 105.790 };
  ...
  it('4. Duplicate coordinate handling should not crash', () => {
    const custA = { id: 'A', latitude: 20.990, longitude: 105.800 };
    const custB = { id: 'B', latitude: 20.990, longitude: 105.800 }; // Identical to A
  ...
  it('5. Route optimization should be deterministic', () => {
    const custA = { id: 'A', latitude: 20.990, longitude: 105.800 };
    const custB = { id: 'B', latitude: 21.050, longitude: 105.850 };
    const custC = { id: 'C', latitude: 20.980, longitude: 105.790 };
...
describe('D. Visit Check-in Radius Geofencing', () => {
  ...
  it('1. Salesperson is within 50m (valid check-in)', () => {
    const salesperson = { latitude: 21.0282, longitude: 105.8540 };
    const dist = calculateDistanceMeters(salesperson.latitude, salesperson.longitude, customer.latitude, customer.longitude);
