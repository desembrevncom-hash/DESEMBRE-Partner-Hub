          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-border pb-4">
              ...
              {!isEditing ? (
                ...
                <Button variant="ghost" size="sm" onClick={() => setIsEditing(false)} className="text-muted-foreground hover:text-foreground">
            ...
            {isEditing ? (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[10px] text-muted-foreground">Lưu ý: Thay đổi email có thể ảnh hưởng đến tài khoản đăng nhập của bạn.</p>
                </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1">
                    <span className="text-sm font-medium text-muted-foreground uppercase tracking-wider text-[10px]">Số điện thoại</span>
                    <p className="font-medium text-base">{user?.user_metadata?.phone || "Chưa cập nhật"}</p>
                  </div>
                  <div className="space-y-1">
                    <span className="text-sm font-medium text-muted-foreground uppercase tracking-wider text-[10px]">Mã QR Zalo</span>
                    <div>
                      {user?.user_metadata?.phone ? (
                        ...
                        <p className="text-sm text-muted-foreground italic mt-1">Cập nhật SĐT để có QR</p>
                      )}
                    </div>
                  </div>
                </div>
