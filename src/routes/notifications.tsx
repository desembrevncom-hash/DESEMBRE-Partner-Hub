      ...
      <header className="bg-white border-b border-slate-200/60 sticky top-0 z-10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-black text-slate-900 tracking-tight uppercase">Trung tâm thông báo</h1>
          </div>
        ...
        <div className="bg-white rounded-[28px] border border-slate-200/60 shadow-sm overflow-hidden">
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center">
              ...
              <p className="text-xs font-bold text-slate-400 mt-4 uppercase tracking-widest">Đang tải thông báo...</p>
            </div>
            ...
            <div className="divide-y divide-slate-100">
              {notifications.map((n) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 shadow-sm ${!n.read_at ? "bg-primary text-white" : "bg-slate-100 text-slate-400"}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <h3 className={`text-base font-bold mb-1 ${!n.read_at ? "text-slate-900" : "text-slate-600"}`}>
                          {n.title}
                        </h3>
                      ...
                      <Badge variant="outline" className="text-[10px] font-bold text-slate-400 border-slate-200 whitespace-nowrap">
            ...
            <div className="py-32 flex flex-col items-center justify-center text-slate-300">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-slate-400">Hộp thư trống</h3>
              <p className="text-xs font-medium text-slate-400 mt-2">Bạn chưa có thông báo nào trong danh sách này.</p>
            </div>
          )}
        </div>
      </main>
