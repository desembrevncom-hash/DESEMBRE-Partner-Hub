    ...
    <div className="min-h-screen bg-white font-sans antialiased text-slate-900">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden md:flex items-center gap-2 mr-2">
              <Button
                variant="ghost"
                asChild
                className="font-bold text-sm text-slate-500 hover:text-slate-900 hover:bg-slate-50 rounded-xl px-5 transition-all"
              >
            ...
            <Button
              asChild
              className="bg-slate-900 hover:bg-indigo-600 rounded-xl px-6 font-bold text-sm shadow-xl shadow-slate-200 transition-all cursor-pointer"
            >
      ...
      <section id="hero" className="py-24 lg:py-32 overflow-hidden bg-slate-50/50">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg font-medium text-slate-500 mb-12 leading-relaxed">
            Hợp nhất Sale, Tele Lead và Quản lý trên một hệ thống thông minh. Tự động hoá quy trình
            chăm sóc, tối ưu doanh thu và chuẩn hoá trải nghiệm khách hàng.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="h-14 px-10 rounded-2xl bg-slate-900 hover:bg-black font-black text-sm shadow-2xl shadow-slate-300"
            >
              <Link to="/login">
                Trải nghiệm Dashboard <ArrowUpRight className="ml-2 w-5 h-5" />
              </Link>
            </Button>
            <Button
              asChild
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-3xl font-black text-slate-900 tracking-tight">
              Vượt xa một phần mềm CRM thông thường
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="container mx-auto px-6 max-w-5xl text-center space-y-8">
          <h2 className="text-3xl lg:text-5xl font-black tracking-tight">
            Sẵn sàng để số hoá hệ thống của bạn?
          </h2>
          <p className="text-slate-400 font-medium text-lg">
            Gia nhập mạng lưới hàng nghìn đối tác cùng Desembre Hub ngay hôm nay.
          </p>
          <Button
            asChild
            size="lg"
            className="bg-white text-slate-900 hover:bg-slate-100 h-16 px-12 rounded-2xl font-black text-lg"
          >
      ...
      <section id="contact" className="py-24 bg-slate-50">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          ...
          <p className="text-3xl font-black text-slate-900 tracking-tight mb-8">
            Bạn cần hỗ trợ hoặc muốn hợp tác?
          </p>
      ...
      <footer className="py-12 bg-white border-t border-slate-100 text-center">
        <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">
          © {new Date().getFullYear()} Desembre Vietnam. Built for Professional Partners.
        </p>
      </footer>
    </div>
  );
...
function FeatureCard({
  ...
  return (
    <div className="p-8 rounded-[32px] bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-all group hover:-translate-y-2">
      <div
        className={`w-14 h-14 rounded-2xl ${color} text-white flex items-center justify-center mb-6 shadow-lg shadow-slate-200 group-hover:scale-110 transition-transform`}
      >
      ...
      <header className="bg-white/80 border-b border-slate-200 sticky top-0 z-40 backdrop-blur-xl">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between max-w-7xl">
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 mt-0.5">
                Chào mừng bạn quay lại không gian làm việc
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <Button
              asChild
              className="rounded-2xl bg-slate-900 hover:bg-black font-black text-xs h-12 px-8 shadow-xl shadow-slate-200 transition-all hover:scale-105 uppercase tracking-widest cursor-pointer"
            >
              <Link to="/customers">
                <PlusIcon className="w-4 h-4 mr-2" /> Thêm khách hàng mới
              </Link>
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="rounded-[40px] border-none shadow-sm bg-white p-8">
            ...
            <div className="mt-10 p-6 bg-slate-900 rounded-[28px] text-center space-y-2">
              ...
              <Badge className="bg-indigo-500/20 text-indigo-300 border-none text-[8px]">
                HIGHT PERFORMANCE
              </Badge>
            </div>
          </Card>
                ...
                <div key={i} className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-black text-slate-900 uppercase tracking-tight">
                      Mới chốt đơn #ORD-220{i}
                    </p>
                    <p className="text-[10px] font-bold text-slate-400">
                      Bởi Nguyễn Văn A • 12 phút trước
                    </p>
                  </div>
    ...
    <Card className="rounded-[32px] border-none shadow-sm hover:shadow-xl transition-all duration-200 bg-white group overflow-hidden">
      <CardContent className="p-8">
        <div className="flex justify-between items-start mb-6">
          <div
            className={`p-4 rounded-[22px] ${color} text-white shadow-lg transition-transform group-hover:scale-110`}
          >
            <Icon className="w-6 h-6" />
          </div>
