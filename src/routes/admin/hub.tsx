...
function AdminControlHub() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4 text-center">
        ...
        <p className="text-slate-500 text-sm max-w-sm mt-2">
          Trang Admin Control Hub chỉ dành riêng cho Quản trị viên.
        </p>
        <Link
          to="/workspace"
  ...
  const groups = [
    ...
    },
    {
      ...
      links: [
        {
          label: "AI Settings (Toggles)",
          to: "/admin/ai-settings",
          icon: <Settings2 className="w-4 h-4" />,
        },
        {
          label: "Product Knowledge (RAG Data)",
          to: "/admin/product-knowledge",
          icon: <BookOpen className="w-4 h-4" />,
        },
        {
          label: "Product Copilot Control",
          to: "/admin/product-copilot",
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "CRM Health Dashboard",
          to: "/admin/crm-health",
          icon: <HeartPulse className="w-4 h-4" />,
        },
        {
          label: "Lead Performance",
          to: "/admin/lead-performance",
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Trung tâm điều khiển và cấu hình hệ thống dành cho Quản trị viên
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {groups.map((group, idx) => (
            <Card
              key={idx}
              className="rounded-2xl border-none shadow-sm hover:shadow-md transition-all bg-white overflow-hidden"
            >
                ...
                <div className="px-4 py-3 bg-slate-50 border-b border-slate-100 grid grid-cols-2 gap-2 text-[11px] font-medium text-slate-600">
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className="text-[9px] bg-slate-100 text-slate-500 px-1 py-0.5 rounded font-bold uppercase tracking-wider">
                        Active
                      </span>
                      <span
                        className={
                  ...
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span
                        className={
                          aiSettings?.ai_customer_suggestions_enabled
                            ? "text-emerald-600 font-bold"
                            : "text-rose-600 font-bold"
                        }
                      >
                  ...
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <span className="font-bold text-slate-900">
                      {aiSettings?.ai_daily_limit || 0}
                    </span>
                  </div>
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    <span>Cache</span>
                    <span className="font-bold text-slate-900">
                      {aiSettings?.ai_cache_minutes || 0}m
                    </span>
                  </div>
                </div>
              )}
                ...
                <div className="px-4 py-3 bg-slate-50 border-b border-slate-100 grid grid-cols-2 gap-2 text-[11px] font-medium text-slate-600">
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span
                        className={
                          autoSettings.pilot_mode_enabled
                  ...
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className="text-[9px] bg-rose-50 text-rose-500 px-1 py-0.5 rounded font-bold uppercase tracking-wider">
                        Disabled for Pilot
                      </span>
                      <span
                        className={
                          autoSettings.automation_enabled
                            ? "text-emerald-600 font-bold"
                            : "text-rose-600 font-bold"
                        }
                      >
                  ...
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span
                        className={
                          autoSettings.due_generator_enabled
                            ? "text-emerald-600 font-bold"
                            : "text-rose-600 font-bold"
                        }
                      >
                  ...
                  <div className="flex items-center justify-between bg-white px-2 py-1.5 rounded border border-slate-100">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span
                        className={
                          autoSettings.notification_enabled
                            ? "text-emerald-600 font-bold"
                            : "text-rose-600 font-bold"
                        }
                      >
