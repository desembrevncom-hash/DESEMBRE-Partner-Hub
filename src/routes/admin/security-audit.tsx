...
const AUDIT_ITEMS: AuditItem[] = [
  ...
  },
  {
    ...
    risk: "medium",
    finding:
      "product-knowledge.tsx dùng { isSalesMember, isAdminOrSubAdmin } — trước P3 là undefined.",
  ...
  return (
    <div className="border border-slate-200 rounded-xl overflow-hidden transition-shadow hover:shadow-md">
      ...
      >
        ...
        {/* Status Badge */}
        <span
          className={`shrink-0 inline-flex items-center gap-1 px-2 py-1 rounded-lg border text-[10px] font-bold ${STATUS_CONFIG[item.status].color}`}
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 font-medium mt-0.5">
                Phase P3 — Permission Penetration Test & Hardening
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2">
      ...
      <main className="container mx-auto px-4 max-w-6xl py-8 space-y-8">
        ...
        <section className="bg-white border border-slate-200 rounded-2xl p-5 space-y-2 text-sm text-slate-600">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            <div className="flex items-start gap-2">
              ...
              <span>
                <strong>PASS</strong> — Đã bảo mật từ trước, không cần thêm hành động.
              </span>
            </div>
            <div className="flex items-start gap-2">
              <ShieldCheck className="w-4 h-4 text-blue-600 mt-0.5 shrink-0" />
              <span>
                <strong>HARDENED</strong> — Lỗ hổng được phát hiện và vá trong Phase P3.
              </span>
            </div>
            <div className="flex items-start gap-2">
              <AlertTriangle className="w-4 h-4 text-amber-500 mt-0.5 shrink-0" />
              <span>
                <strong>PARTIAL</strong> — Bug frontend được fix trong P3 (biến undefined).
              </span>
            </div>
            <div className="flex items-start gap-2">
              <XCircle className="w-4 h-4 text-red-500 mt-0.5 shrink-0" />
              <span>
                <strong>OPEN</strong> — Chưa xử lý (hiện không có).
              </span>
            </div>
          </div>
        </section>
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-5 flex gap-3 items-start">
          ...
          <div className="text-sm text-indigo-700">
            ...
            <p>
              Audit bao gồm toàn bộ 8 bảng AI (ai_settings, rag_audit_logs, ai_safety_events,
              ai_conversation_logs, product_knowledge, product_knowledge_chunks, ai_usage_logs,
              ai_assistant_logs), 5 RPCs, 2 Edge Functions và 4 Frontend Routes. Không thêm AI
              feature mới trong phase này.
            </p>
          </div>
        </div>
      </main>
