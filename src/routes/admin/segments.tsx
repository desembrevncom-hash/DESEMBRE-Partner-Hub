...
function CustomerSegmentsPage() {
  ...
  const fetchSegments = async () => {
    ...
    const mockSegments: Segment[] = [
      {
        id: "1",
        name: "VIP Partners - Miền Bắc",
        description: "Đại lý có doanh số > 200M tại khu vực phía Bắc",
        type: "dynamic",
        count: 42,
      ...
      {
        id: "2",
        name: "Inactive Leads (60d)",
        description: "Lead chưa có tương tác hoặc đơn hàng trong 60 ngày",
        type: "dynamic",
        count: 128,
      ...
      {
        id: "3",
        name: "Workshop Attendees Hanoi",
        description: "Danh sách khách tham dự Workshop 15/05",
        type: "static",
        count: 85,
      ...
      },
      {
        ...
        description: 'Khách đang ở giai đoạn "Khách đã mua" nhưng chưa mua lại',
        type: "dynamic",
        count: 56,
        last_updated: "2026-05-13T15:45:00Z",
        color: "amber",
      },
    ];
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl space-y-8">
            ...
            <CardHeader className="p-8 pb-4 border-b border-slate-50 flex flex-row items-center justify-between">
              <div>
                <CardTitle className="text-lg font-black text-slate-900">
                  Thiết lập Phân khúc Thông minh
                </CardTitle>
                <p className="text-xs text-slate-400 font-medium">
                  Định nghĩa điều kiện lọc tự động cho tệp khách hàng
                </p>
              </div>
            ...
            <CardContent className="p-8 space-y-6">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-50 rounded-[24px] p-6 border border-dashed border-slate-200 flex flex-col items-center justify-center space-y-3">
                  ...
                  <p className="text-xs font-bold text-slate-500 text-center">
                    Xây dựng bộ lọc điều kiện (SQL-like Filter)
                  </p>
                  <Button
                    variant="outline"
                    className="rounded-xl border-indigo-100 text-indigo-600 font-bold text-[10px]"
                  >
              ...
              <div className="pt-6 border-t border-slate-50 flex justify-end gap-3">
                ...
                <Button
                  ...
                  className="rounded-xl bg-indigo-600 font-black px-8 h-12 shadow-lg shadow-indigo-100"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {segments.map((segment) => (
            <Card
              key={segment.id}
              className="rounded-[32px] border-none shadow-sm overflow-hidden bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
            >
              <CardContent className="p-8">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="rounded-xl text-slate-300 group-hover:text-slate-900 transition-all"
                    >
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant="outline"
                      className={`rounded-lg font-black text-[9px] uppercase border-none ${
                        segment.type === "dynamic"
                ...
                <div className="mt-8 pt-6 border-t border-slate-50 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-black text-slate-900">
                      {segment.count}{" "}
                      <span className="text-[10px] font-bold text-slate-400">ĐỐI TÁC</span>
                    </p>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-xs font-bold text-slate-600">
                      {new Date(segment.last_updated).toLocaleTimeString("vi-VN", {
                        hour: "2-digit",
                        minute: "2-digit",
                      })}
                    </p>
                ...
                <div className="mt-6 flex gap-2">
                  <Button
                    variant="outline"
                    className="flex-1 rounded-xl border-slate-100 text-[10px] font-black text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 hover:border-indigo-100"
                  >
  ...
  return (
    <Card className="rounded-[28px] border-none shadow-sm overflow-hidden bg-white hover:shadow-md transition-all group">
      <CardContent className="p-6 flex items-center justify-between">
        ...
        <div
          className={`w-14 h-14 rounded-2xl flex items-center justify-center border transition-all group-hover:rotate-6 ${colors[color]}`}
        >
