  ...
  return (
    <>
      <Button 
        ...
        className="fixed bottom-6 right-6 rounded-full h-12 px-5 shadow-xl shadow-indigo-200 bg-indigo-600 hover:bg-indigo-700 text-white z-50 transition-all hover:scale-105 flex items-center gap-2"
      >
