                  ...
                  <div className="flex items-start gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start gap-2">
                        <h4
                          className={`text-[13px] font-bold transition-colors line-clamp-1 ${
                            isCompleted
                      ...
                      <p className="text-[10px] text-slate-400 font-medium mt-0.5 truncate">
                        🏢{" "}
                        {item.customer?.facility_name ||
                          item.lead?.facility_name ||
                          item.location ||
                          "Spa tự do"}
                      </p>
                    </div>
                    ...
                    <div className="shrink-0" onClick={(e) => e.stopPropagation()}>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-44">
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              setTaskAction({ task: item, action: "transfer_to_sale" })
                            }
                          >
                ...
                <div className="mt-1 pl-8 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {isAppointment ? (
                      <Badge
                        variant="outline"
                        className="text-[9px] font-bold px-1.5 py-0 bg-indigo-50 text-indigo-600 border-indigo-100 uppercase tracking-wider"
                      >
                      ...
                      <Badge
                        variant="outline"
                        className="text-[9px] font-bold px-1.5 py-0 bg-slate-50 text-slate-500 border-slate-200 uppercase tracking-wider"
                      >
                    ...
                    {!isAppointment && isTaskOverdue(item.due_at, item.status) && (
                      <Badge className="bg-red-50 text-red-655 border-red-100 text-[9px] font-bold uppercase tracking-wider">
                        Quá hạn
                      </Badge>
                    )}
                  </div>
