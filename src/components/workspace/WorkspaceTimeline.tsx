  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-xs h-full flex flex-col">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-sm font-black uppercase tracking-wider text-slate-950">Lịch trình hôm nay</h3>
      </div>
      ...
      {events.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center py-6 text-center bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
          ...
          <p className="text-xs font-bold text-slate-600">Trống lịch, hãy tập trung xử lý công việc!</p>
        </div>
      ) : (
            ...
            {events.map((event) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Card */}
                  <div className={`flex-1 p-3 rounded-2xl border transition-all hover:shadow-md ${colorClasses}`}>
