  ...
  const kpiItems = [
    {
      ...
      icon: <Phone className="w-12 h-12 text-blue-50/50 absolute right-4 bottom-4" />,
      color: "text-blue-600",
    ...
    },
    {
      ...
      icon: <Clock className="w-12 h-12 text-orange-50/50 absolute right-4 bottom-4" />,
    ...
    },
    {
      ...
      icon: <UserCheck className="w-12 h-12 text-emerald-50/50 absolute right-4 bottom-4" />,
    ...
    },
    {
      ...
      icon: <FileText className="w-12 h-12 text-purple-50/50 absolute right-4 bottom-4" />,
    ...
    },
    {
      ...
      icon: <Package className="w-12 h-12 text-slate-50/50 absolute right-4 bottom-4" />,
    ...
    },
    {
      ...
      icon: <AlertCircle className="w-12 h-12 text-rose-50/50 absolute right-4 bottom-4" />,
      color: "text-rose-600",
        ...
        >
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="flex items-end justify-between">
              <span className={`text-4xl font-black tracking-tighter ${item.value > 0 ? 'text-slate-800' : 'text-slate-300'}`}>
                {item.value}
              </span>
              <span className="text-[10px] font-bold text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity">Xem</span>
            </div>
          </div>
          {item.icon}
        </div>
