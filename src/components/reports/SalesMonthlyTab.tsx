...
export function SalesMonthlyTab({
  selectedSaleId,
  onPeriodChange,
}: {
      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            />
            <MetricCard
              title="Khách mua (90 Ngày)"
              value={metrics.active_90_day_customers || 0}
              icon={<Users />}
              color="text-pink-600"
              bg="bg-pink-50"
            />
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
            ...
            <div className="space-y-2 text-sm">
              <p>
                <span className="font-semibold w-40 inline-block">Dự kiến đơn tháng tới:</span>{" "}
