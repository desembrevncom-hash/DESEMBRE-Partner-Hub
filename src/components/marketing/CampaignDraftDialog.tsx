...
export function CampaignDraftDialog({
  open,
  onOpenChange,
  onSuccess,
  userId,
}: CampaignDraftDialogProps) {
  ...
  const handlePreview = async () => {
    ...
    try {
      const [
        ...
        supabase
          .from("customers")
          .select("id, name, phone, email, status, last_contacted_at")
          .limit(5000),
    ...
    >
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-amber-50 text-amber-800 p-3 rounded-md border border-amber-200 text-sm flex items-start gap-2">
          ...
          <p>
            <strong>Phase này chỉ tạo chiến dịch nháp.</strong> Hệ thống chưa kích hoạt tính năng
            gửi Email/Zalo thật để bảo đảm an toàn dữ liệu.
          </p>
        </div>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                value={
                  channel === "email"
                    ? "Email Ready (Đã Consent)"
                    : "Zalo Ready (Đã Consent/Follow)"
                }
          ...
          <div className="space-y-1">
            ...
            <Textarea
              ...
              placeholder="Soạn nội dung nháp tại đây..."
            />
          </div>
