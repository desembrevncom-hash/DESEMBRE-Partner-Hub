...
import { MessageSquare, X, Send, Sparkles, Loader2, Copy, Bot, User, RefreshCcw, Save, FileText, Check } from "lucide-react";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-white/60 font-medium flex items-center gap-1.5">
                  ...
                  {customerContext ? `Đang hỗ trợ: ${customerContext.customerName}` : "Cẩm nang sản phẩm"}
                </p>
              </div>
            </div>
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-4 text-slate-500 fade-in">
                ...
                <div className="w-full pt-4 space-y-2">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Gợi ý câu hỏi</p>
                      ...
                      {msg.role === 'assistant' && !msg.isError && (
                        <div className="mt-1 flex flex-col gap-2 w-full">
                          <div className="flex flex-wrap items-center gap-1.5">
                            ...
                            >
                              {copiedZaloId === msg.id ? <Check className="w-3 h-3 text-emerald-500" /> : <MessageSquare className="w-3 h-3" />} Copy Zalo
                            </button>
                            <button 
                              ...
                              title={!customerContext ? "Vui lòng mở một khách hàng để lưu ghi chú" : ""}
                            >
                          ...
                          <p className="text-[9px] text-slate-400 italic">Gợi ý từ cẩm nang sản phẩm. Vui lòng kiểm tra trước khi gửi khách.</p>
                        </div>
                      )}
                    </div>
                  </div>
